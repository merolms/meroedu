...
func (_m *TagUseCase) CreateCourseTag(ctx context.Context, tagID int64, courseID int64) error {
...
func (_m *TagUseCase) CreateLessonTag(ctx context.Context, tagID int64, lessonID int64) error {
...
func (_m *TagUseCase) DeleteCourseTag(ctx context.Context, tagID int64, courseID int64) error {
	ret := _m.Called(ctx, tagID, courseID)
...
func (_m *TagUseCase) DeleteLessonTag(ctx context.Context, tagID int64, lessonID int64) error {
	ret := _m.Called(ctx, tagID, lessonID)
...
func (_m *TagUseCase) GetAll(ctx context.Context, searchQuery string, start int, limit int) ([]domain.Tag, error) {
...
func (_m *TagUseCase) GetCourseTags(ctx context.Context, courseID int64) ([]domain.Tag, error) {
...
func (_m *TagUseCase) GetLessonTags(ctx context.Context, lessonID int64) ([]domain.Tag, error) {
