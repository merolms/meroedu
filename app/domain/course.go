...
type Course struct {
	...
	Authors     User         `json:"authors,omitempty" gorm:"many2many:course_author;"`
...
type CourseUseCase interface {
	GetAll(ctx context.Context, skip int, limit int) ([]Course, error)
...
type CourseRepository interface {
	...
	GetByTitle(ctx context.Context, title string) (Course, error)
	// Update(ctx context.Context, course *Course) error
	CreateCourse(ctx context.Context, course *Course) (int64, error)
}
